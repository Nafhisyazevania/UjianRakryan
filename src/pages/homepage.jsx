        ...
        <div>
            ...
            <div className='bg-banner' id='contact'>
                <div className='pt-5 text-center'>
                    <h1 className='fw-bold'>Lets Design Together</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet rerum iusto hic natus animi molestias impedit laudantium nihil sit, incidunt dolor, cupiditate praesentium atque accusamus porro unde vitae minus consequuntur.</p>
                </div>
